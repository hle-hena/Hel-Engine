...
/*                                                                            */
/*  Last Modified: 2026/03/14 19:21:22                                        */
/*             By: hle-hena                                                   */
/*                                                                            */
/*    -----                                                                   */
/*                                                                            */
...
void	UiContext::initImGuiStyle(void) {
	...
	colors[ImGuiCol_TextDisabled] =
			ImVec4(0.36f, 0.42f, 0.47f, 1.00f);
	...
	colors[ImGuiCol_CheckMark] =
			ImVec4(0.28f, 0.56f, 1.00f, 1.00f);
	...
	colors[ImGuiCol_Header] =
			ImVec4(0.20f, 0.25f, 0.29f, 0.55f);

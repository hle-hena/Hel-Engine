...
/*                                                                            */
/*  Last Modified: 2026/07/25 17:32:22                                        */
/*             By: hle-hena                                                   */
/*                                                                            */
/*    -----                                                                   */
/*                                                                            */
...
class	Dock {
	public:
		...
		void	render(RenderRequest *uiRequest, const ExecutionContext &ctx, const ImVec2 &size,
	...
	private:
		...
		void	renderPanels(RenderRequest *uiRequest, const ExecutionContext &ctx, const ImVec2 &size);
		std::vector<IPanel *>	_panels{};
		std::vector<float>		_gaps{};

		void	renderSplits(RenderRequest *uiRequest, const ExecutionContext &ctx, const ImVec2 &size, const ImVec2 &rescale);
